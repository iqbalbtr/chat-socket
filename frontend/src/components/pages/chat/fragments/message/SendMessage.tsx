    ...
    return (
        <div >
            <div
                ...
                style={{
                    bottom: tglClip ? pull ? "200px" : "144px" : pull ? "60px" : "0px"
                }}
            >
                {
                    ...
                    >
                        {
                            tglClip ? (
                                ...
                                <svg width={25} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="plus">
                                    <path fill="#000" d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"></path>
                                </svg>
                            )
                        }
                    </button>
                    <input type="text" value={input} onChange={(e) => setInput(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleSending()} className={style.field} />
                    <button
